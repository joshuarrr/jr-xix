        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            config.routes.forEach(function (route) {
              ...
              route.template = (0, _slash.default)(_path.default.relative(config.paths.DIST, _path.default.resolve(config.paths.ROOT, route.component))); // Check if the template has already been added
